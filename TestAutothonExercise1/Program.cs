...
namespace TestAutothonExercise1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //                    var wikiDir = chrome2.WaitForElementsAndGet("//table[contains(@class,'infobox vevent')]/tbody/tr/th[contains(text(),'Directed by')]/following-sibling::td/a")
            //                                          .Select(e => e.Text).ToList();
            //                    var imdbLink = LinkFinders.FindImdb(chrome2)?.First();
            //                    chrome2.Navigate().GoToUrl($"{imdbLink.GetAttribute("href")}fullcredits");
            //                    var imdbDir = chrome2.WaitForElementsAndGet("//div[contains(@id,'fullcredits_content')]/h4[contains(text(),'Directed by')]/following-sibling::table[1]/tbody/tr/td/a")
            //                                        .Select(e => e.Text).ToList(); ;
